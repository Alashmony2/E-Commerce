    ...
    return (
        <div className="relative flex flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md hover:shadow-2xl transition-all duration-500 hover:scale-105">
                ...
                <div className="mt-4 px-5 pb-5 grow flex flex-col justify-between">
                    ...
                    <Button isLoading={isLoading} onPress={() => addProductToCart(product._id,setIsLoading)} className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
